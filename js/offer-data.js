...
window.OFFER_DATA = {
  ...
  panel: {
    r1: {
      priced: ["Full-cycle enterprise selling (six- and seven-figure ACV, multi-threaded, 6 to 12 month cycles)", "Qualification discipline (MEDDICC/MEDDPICC), forecast accuracy, self-sourced pipeline", "Executive relationships and business-case selling", "Procurement, legal, and security review", "Partner and channel co-sell"],
    ...
    r4: {
      priced: ["Everything the Sr. Enterprise AE is priced on, plus consumption and usage-based selling and forecasting (tokens, compute, committed spend) rather than seat-based ARR", "Use-case discovery for a new category, working with product teams so customers can build on the platform", "Technical-buyer fluency (CTO, CDO, Head of AI) and AI-specific objections (data usage and training rights, model risk, privacy, governance, evaluation)", "Pilot-to-enterprise expansion", "Hyperscaler and SI partner ecosystems, including marketplace transactions"],
